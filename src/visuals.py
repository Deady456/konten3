...
def search_galaxy_bank_video(query: str) -> list[Path]:
    ...
    if not matched_folders:
        # Fallback to any general space categories if space-related
        matched_folders = [GALAXY_BANK_DIR / "01_black_holes", GALAXY_BANK_DIR / "02_galaxies_nebulae", GALAXY_BANK_DIR / "04_exoplanets"]
